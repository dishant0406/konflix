    ...
    <div className='w-[100vw] transition-all duration-300 items-center h-[50vh] flex flex-col justify-between ' style={{
      ...
      <div className='w-[90vw]'>
        ...
        <div className=' mb-[-3rem] gap-[40px] hidden md:flex'>
          <div  onClick={() => setSelectedAnime(anime)} style={{
                  boxShadow: '0 8px 32px 0 rgba( 31, 38, 135, 0.37 )',
                  backdropFilter: 'blur(10px)',
                  backgroundColor: 'rgba( 0,0,0,0.45)'

                  }} className={`w-[200px] flex items-center justify-center cursor-pointer transition-all duration-300  ${true ? 'border-white border-[2px] scale-110' : 'opacity-50'} h-[120px]  rounded-[20px]`}>
